...
void
RequestEngine::Init(std::string sInitFileName)
{
...
void
RequestEngine::LoadInitParams(std::string sInitFileName)
{
...
void
RequestEngine::initSocketManager()
{
...
//----------------------------------------------------------------------------
void
RequestEngine::trace(std::string pTracePtr[], int nbString, TRACETYPE iTraceLevel)
{
try
{
...
*/
  ...
  sTraceFileName = std::string("traceEngine.inf") ;
	ofstream outFile ;
