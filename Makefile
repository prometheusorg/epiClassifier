...
SRCEPISOD	= $(EPIPATH)/nsepisod/nsclasser.cpp $(EPIPATH)/nsepisod/eptables.cpp $(EPIPATH)/nsepisod/flechiesDB.cpp

#SRCEPISOD	= $(EPIPATH)/nsepisod/nsclasser.cpp $(EPIPATH)/nsepisod/eptables.cpp $(EPIPATH)/nsepisod/nsldvuti.cpp $(EPIPATH)/nsepisod/flechiesDB.cpp
...
OBJEPISOD	= $(EPIPATH)/nsepisod/nsclasser.o $(EPIPATH)/nsepisod/eptables.o $(EPIPATH)/nsepisod/flechiesDB.o
...
# librairies
LIB	= -lmysqlclient -lnspr4 -lpthread -lconfig++
