...
//---------------------------------------------------------------------------
string NSDico::SetData(string sItem, string* pUnite,
                       NSPatPathoArray* pPathoDocEnCours) {
...
void NSDico::separe(string* psChaine, string* psLexique, string* psCertitude,
                    string* psPluriel) {
  *psCertitude = "";
  *psPluriel   = "";
