...
//---------------------------------------------------------------------------
#ifdef __WINDOWS__
USEUNIT("enterpriseLus\identityLus.cpp");
USELIB("engineLus.lib");
USELIB("nssavoirLus.lib");
USELIB("nsutilLus.lib");
USELIB("nsbbLus.lib");
USELIB("personsLus.lib");
USELIB("nsepisodLus.lib");
USELIB("nsdatabaseLus.lib");
//---------------------------------------------------------------------------
#pragma argsused
#endif
